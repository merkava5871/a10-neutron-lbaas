...
# class DeleteAppliance(workflows.Workflow):
#     slug = "deleteappliance"
#     name = _("Delete Appliance")
#     finalize_button_name = _("Delete")

#     success_message = _('Deleted appliance "%s".')
#     failure_message = _('Unable to delete appliance "%s".')
#     success_url = "horizon:project:a10appliances:index"
#     # default_steps = (DeleteApplianceStep,)
...
#         # Create the instance manager, giving it the context so it knows how to auth
#         instance_mgr = instance_manager_for(request)
#         instance_data = instance_mgr.delete_instance(context.get("id"))
