...
log $VNC_CMD_BASE/service_appliance_set.py --api_server_ip $VNC_API_IP --api_server_port $VNC_API_PORT --oper del --admin_user $VNC_USER --admin_password $VNC_PASSWORD --admin_tenant_name $VNC_TENANT --name a10networks --driver \"$DRIVER_PATH\" 
